...
class CheckDoorWay: public Task{
public:
	CheckDoorWay(float d);
	bool run(Blackboard* bb);
	float dist;
};
...
class CheckDirectVision: public Task{
public:
	CheckDirectVision();
	bool run(Blackboard* bb);
};
...
class ObstacleAvoidanceTask: public Task{
public:
