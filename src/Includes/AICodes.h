...
enum AI_code{
	...
	AI_TASK_TRAVEL		= 0x0A,	// (Puntero) SubArbol de decisiones de calcular la sala a la que moverse
	AI_TASK_EXPLORE 	= 0x0B,	// (Puntero) SubArbol de decisiones de explorar sala
	AI_TASK_DEFUSE_TRAP	= 0x0C, // (Puntero) SubArbol de decisiones de desactivar trampa
	AI_TASK_DRINK_POT	= 0x0D, // (Puntero) SubArbol de decisiones de tarea beber pocion
	AI_TASK_CATCH_POT	= 0x0E, // (Puntero) SubArbol de decisiones de tarea coger pocion
	AI_TASK_USE_FOUNT	= 0x0F,	// (Puntero) SubArbol de decisiones de tarea usar fuente
	AI_TASK_ESCAPE		= 0x10,	// (Puntero) SubArbol de decisiones de tarea escapar
	AI_TASK_SHOOT_SPELL	= 0x11,	// (Puntero) SubArbol de decisiones de tarea disparar habilidad
	AI_TASK_SPELL00		= 0x12,	// (Puntero) SubArbol de decisiones del hechizo 00
	AI_TASK_SPELL01 	= 0x13,	// (Puntero) SubArbol de decisiones del hechizo 01
	AI_TASK_SPELL02 	= 0x14,	// (Puntero) SubArbol de decisiones del hechizo 02
	AI_TASK_SPELL03 	= 0x15,	// (Puntero) SubArbol de decisiones del hechizo 03
