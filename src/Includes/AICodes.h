...
static std::string AICode_str[] = {
	...
	"AI_DOOR",					// 0x07
	"AI_TRAP",					// 0x08
	"AI_TASK_DEFAULT",			// 0x09
	"AI_TASK_CATCH_GRAIL",		// 0x0A
	"AI_TASK_TRAVEL",			// 0x0B
	"AI_TASK_EXPLORE",			// 0x0C
	"AI_TASK_DEFUSE_TRAP",		// 0x0D
	"AI_TASK_DRINK_POT",		// 0x0E
	"AI_TASK_CATCH_POT",		// 0x0F
	"AI_TASK_USE_FOUNT",		// 0x10
	"AI_TASK_ESCAPE",			// 0x11
	"AI_TASK_SHOOT_SPELL",		// 0x12
	"AI_TASK_SPELL00",			// 0x13
	"AI_TASK_SPELL01",			// 0x14
	"AI_TASK_SPELL02",			// 0x15
	"AI_TASK_SPELL03",			// 0x16
	"AI_MOVE_DEFAULT",			// 0x17
	"AI_MOVE_NO",				// 0x18
	"AI_MOVE_ESCAPE",			// 0x19
	"AI_MOVE_INTERACT",			// 0x1A
	"AI_MOVE_TRAVEL",			// 0x1B
	"AI_MOVE_OPEN_DOOR",		// 0x1C
	"AI_MOVE_EXPLORE",			// 0x1D
	"AI_MOVE_GOTARGET",			// 0x1E
	"AI_MOVE_TARGETPATH",		// 0x1F
	"AI_MOVE_FOUNTAIN",			// 0x20
	"AI_MOVE_FACE",				// 0x21
	"AI_MOVE_AVOID",			// 0x22
	"AI_MOVE_SPELL00",			// 0x23
	"AI_MOVE_SPELL01",			// 0x24
	"AI_MOVE_SPELL02",			// 0x25
	"AI_MOVE_SPELL03",			// 0x26
	"AI_TARGET",				// 0x27
	"AI_DELTA"					// 0x28	
};
