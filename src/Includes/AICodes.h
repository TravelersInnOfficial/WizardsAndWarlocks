...
enum AI_code
{
	...
	AI_MOVE_SPELL02 = 0x10, // (Puntero) SubArbol de decisiones de movimiento del hechizo 02
	AI_MOVE_SPELL03 = 0x11, // (Puntero) SubArbol de decisiones de movimiento del hechizo 03
	//CODIGOS SENSE
	AI_PLAYER		= 0x12	// Codigo player sense
};
