...
static int potionCW 		= C_DOOR		|	C_WALL			|	C_GRAIL		|	C_FOUNTAIN	|	C_NPC;
static int playerCW			= C_WALL		|	C_DOOR			|	C_GRAIL		|	C_FOUNTAIN	|	C_TRAP		|	C_PROJECTILE	|	C_PLAYER		|	C_NPC;
...
static int projectileCW		= C_WALL		|	C_PLAYER		|	C_GRAIL		|	C_SWITCH	|	C_TRAP		|	C_DOOR			|	C_FOUNTAIN		|	C_NPC;
static int trapCW			= C_PROJECTILE	|	C_PLAYER;
static int npcCW			= C_PROJECTILE	|	C_PLAYER		|	C_POTION;
