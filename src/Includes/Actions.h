...
enum ACTION_ENUM
{
	...
	ACTION_RESET_RECEIVER		= 0x10,		// Resetear el Receiver (Menu del NPC)
	ACTION_CHANGE_SPELL_UP 		= 0x11,		// Cambiar el hechizo +1
	ACTION_CHANGE_SPELL_DOWN 	= 0x12		// Cambiar el hechizo -1
};
