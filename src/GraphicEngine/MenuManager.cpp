...
void MenuManager::UpdateNetDebug(std::vector<Player*> players){
	...
	if(netDebugWindow != NULL){
		...
		if(players.size() > 0 && players.at(0) != NULL){
			std::string player1_s = "Player 1: "+ std::to_string(players.at(0)->GetHP()) +" HP / "+ std::to_string(players.at(0)->GetMP()) +" MP";
		...
		if(players.size() > 1 && players.at(1) != NULL){
			std::string player2_s = "Player 2: "+ std::to_string(players.at(1)->GetHP()) +" HP / "+ std::to_string(players.at(1)->GetMP()) +" MP";
		...
		if(players.size() > 2 && players.at(2) != NULL){
			std::string player3_s = "Player 3: "+ std::to_string(players.at(2)->GetHP()) +" HP / "+ std::to_string(players.at(2)->GetMP()) +" MP";
		...
		if(players.size() > 3 && players.at(3) != NULL){
			std::string player4_s = "Player 4: "+ std::to_string(players.at(3)->GetHP()) +" HP / "+ std::to_string(players.at(3)->GetMP()) +" MP";
		...
		if(players.size() > 4 && players.at(4) != NULL){
			std::string player5_s = "Player 5: "+ std::to_string(players.at(4)->GetHP()) +" HP / "+ std::to_string(players.at(4)->GetMP()) +" MP";
		...
		if(players.size() > 5 && players.at(5) != NULL){
			std::string player6_s = "Player 6: "+ std::to_string(players.at(5)->GetHP()) +" HP / "+ std::to_string(players.at(5)->GetMP()) +" MP";
		...
		if(players.size() > 6 && players.at(6) != NULL){
			std::string player7_s = "Player 7: "+ std::to_string(players.at(6)->GetHP()) +" HP / "+ std::to_string(players.at(6)->GetMP()) +" MP";
		...
		if(players.size() > 7 && players.at(7) != NULL){
			std::string player8_s = "Player 8: "+ std::to_string(players.at(7)->GetHP()) +" HP / "+ std::to_string(players.at(7)->GetMP()) +" MP";
		...
		ClearElement(NETDEBUG_M_P1);
		ClearElement(NETDEBUG_M_P2);
		ClearElement(NETDEBUG_M_P3);
		ClearElement(NETDEBUG_M_P4);
		ClearElement(NETDEBUG_M_P5);
		ClearElement(NETDEBUG_M_P6);
		ClearElement(NETDEBUG_M_P7);
		ClearElement(NETDEBUG_M_P8);	
